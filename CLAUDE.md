...
10. `index.html` is a **build artifact** generated by `./build.sh` from the partials in `content/`. Never edit `index.html` directly — the change will be silently reverted the next time anyone runs the build. Edit `content/*.html`, then run `./build.sh`.
